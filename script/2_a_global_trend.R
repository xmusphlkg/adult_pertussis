...
fig_a <- plot_apc(model_rate_incidence, df_global_rate_incidence, F)+
...
fig_b <- plot_apc(model_rate_dalys, df_global_rate_dalys, F)+
  guides(fill = guide_legend(ncol=4, byrow=TRUE))+
  labs(x='Year',
...
rm(df_aapc_incidence_number, df_aapc_dalys_number,
   df_aapc_incidence_rate, df_aapc_dalys_rate,
   df_aapc)
